...
<head>
<meta charset="UTF-8">
<title>Profesor 1</title>
<style>
.barra-container { width: 100%; background: #ddd; border-radius: 10px; overflow: hidden; margin-top:20px; }
.barra { height: 30px; width: 0%; background: green; text-align: center; color: white; line-height: 30px; transition: width 0.5s; }
</style>
</head>
<body>
<h1>Profesor 1</h1>
